...
from realtimefft.fft import getFFT
from realtimefft.utils import *
...
class Stream_Analyzer:
    ...
    def __init__(self,
        ...
        try:
            from realtimefft.stream_reader_pyaudio import Stream_Reader
            ...
            from realtimefft.stream_reader_sounddevice import Stream_Reader
            self.stream_reader = Stream_Reader(
                device  = device,
                rate    = rate,
                updates_per_second  = updates_per_second,
        ...
        if self.visualize:
            from realtimefft.visualizer import Spectrum_Visualizer
